<template>
    <q-page class="container q-pa-md" padding>
        <h1 class="q-ma-none stitle">Terms and Conditions</h1>
        ...
        <div>
            ...
            <p>
                The EDMS platform may use “cookies” and similar technologies such as pixel tags and web beacons to improve system efficiency and to deliver personalized and secure access to authorized users. These technologies assist in optimizing system performance and ensuring a smooth user experience.
            </p>
            ...
            <p>
                Any data or content entered into the EDMS, including personal or employment-related information, may be accessible to authorized officials within the department based on their roles and permissions. Such access is strictly governed by departmental policies and government data protection guidelines.
            </p>
            ...
            <p>
                This policy shall be governed by and construed in accordance with the laws of India. Any dispute arising under this policy shall be subject to the exclusive jurisdiction of the High Court.
            </p>
        </div>
    </q-page>
</template>
